...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulación de login (más adelante conectaremos al backend)
  ...
  return (
    <main className="form-container container py-5" style={{ maxWidth: "500px" }}>
      <h1 className="text-center mb-4">Iniciar Sesión</h1>

      <form id="formLogin" onSubmit={handleSubmit} className="d-flex flex-column gap-3">
        <div>
