    ...
    <main className="admin-container container py-5">
      ...
      <section className="mb-5">
        ...
        <form onSubmit={handleProductoSubmit} className="d-flex flex-wrap gap-2 mb-3">
          ...
          <input type="number" name="precioProd" placeholder="Precio" required className="form-control w-auto" />
      ...
      <section>
        ...
        <form onSubmit={handleUsuarioSubmit} className="d-flex flex-wrap gap-2 mb-3">
          <input type="text" name="nombreUsuario" placeholder="Nombre" required className="form-control w-auto" />
